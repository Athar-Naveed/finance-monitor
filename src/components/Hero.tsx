    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-black via-purple-900/20 to-black">
      ...
      >
        <motion.div variants={fadeInUp} className="text-center">
          ...
          >
            <button className="w-full sm:w-auto bg-white text-black px-6 py-2 rounded hover:bg-neutral-200 transition-colors flex items-center justify-center gap-x-2">
              Get Started
              <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="w-full sm:w-auto bg-black border border-neutral-800 text-white px-6 py-2 rounded hover:bg-neutral-800 transition-colors">
              View Demo
            </button>
          </motion.div>
